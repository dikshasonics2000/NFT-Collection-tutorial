...
pragma solidity ^0.8.4;
  ...
  contract CryptoDevs is ERC721Enumerable, Ownable { // inheriting class
     ...
     modifier onlyWnenNotPaused {
      ...
      function presaleMint() public payable onlyWnenNotPaused{
      ...
      function mint() public payable onlyWnenNotPaused{
